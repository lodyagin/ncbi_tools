...
!IF  "$(CFG)" == "demo_copymat - Win32 DebugMT"
...
# ADD LINK32 oldnames.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /nologo /incremental:yes /subsystem:console /pdb:none /debug /machine:I386 /out:"DebugMT/copymat.exe" /pdbtype:sept
