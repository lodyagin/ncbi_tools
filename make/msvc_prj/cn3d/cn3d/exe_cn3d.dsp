...
# ADD CPP /nologo /MTd /W3 /Gm /GR /Z7 /Od /I "..\..\..\.." /I "..\..\..\..\asnlib" /I "..\..\..\..\api" /I "..\..\..\..\corelib" /I "..\..\..\..\biostruc" /I "..\..\..\..\cdromlib" /I "..\..\..\..\ddv" /I "..\..\..\..\desktop" /I "..\..\..\..\object" /I "..\..\..\..\tools" /I "..\..\..\..\vibrant" /I "..\..\..\..\cn3d" /I "..\..\..\..\network\vibnet" /D "_OPENGL" /D "WIN32" /D "_DEBUG" /YX /FD /GZ /c
...
# ADD LINK32 oldnames.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib wsock32.lib opengl32.lib glu32.lib /nologo /incremental:yes /subsystem:windows /pdb:none /debug /machine:I386 /out:"DebugMT/cn3d.exe" /pdbtype:sept
