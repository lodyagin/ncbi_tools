...
!IF  "$(CFG)" == "exe_asntool - Win32 DebugDLL"
...
# ADD LINK32 oldnames.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib /nologo /incremental:yes /subsystem:windows /pdb:none /debug /machine:I386 /out:"DebugDLL/asntool.exe" /pdbtype:sept
