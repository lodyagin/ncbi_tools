...
static void Cn3D_ExportPDB(IteM i)
{
    ...
    if (Cn3D_Export_InUse) return;
    else Cn3D_Export_InUse = TRUE;
    ...
    sprintf(pcSavestr,  "Save %s As a PDB Formatted File ...",  Cn3D_pcPDBName);
    ...
    Cn3D_tPDBSave = DialogText(g2,pcSavename, 18 , (TxtActnProc) Cn3D_PDBEnableProc);
    MemFree(Cn3D_pcPDBName);
 
    Cn3D_bPDBBrowse = PushButton(g2, " browse...", (BtnActnProc) Cn3D_PDBBrowseProc);    
...
static void Cn3D_ExportKin(IteM i)
{
    ...
    sprintf(pcSavestr,  "Save %s As a Kinemage Rendered File ...",  Cn3D_pcKinName);
    ...
    Cn3D_tKinSave = DialogText(g2,pcSavename, 18 , (TxtActnProc) Cn3D_KinEnableProc);
    MemFree(Cn3D_pcKinName);
 
    Cn3D_bKinBrowse = PushButton(g2, " browse...", (BtnActnProc) Cn3D_KinBrowseProc);    
    g3 = HiddenGroup(g, 2, 0,  NULL);
    ...
    Cn3D_gColorAtoms = NormalGroup(g, 2, 2, " color by...", systemFont, NULL);
    ...
    Cn3D_gRenderOpts = NormalGroup(g, 2, 3, " viewable subsets...", systemFont, NULL);
    ...
    Cn3D_bRender[4] = CheckBox(Cn3D_gRenderOpts, "Alternate Conformations", NULL);
