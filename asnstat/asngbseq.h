...
static char * asnfilename = "asngbseq.h11";
static AsnType atx[125] = {
  ...
  {413, "GBAuthor" ,1,0,0,0,0,0,0,0,NULL,&atx[4],NULL,0,&atx[60]} ,
  ...
  {412, "GBXref" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[48],0,&atx[41]} ,
  ...
  {407, "GBComment" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[57],0,&atx[63]} ,
  ...
  {414, "GBCommentParagraph" ,1,0,0,0,0,0,0,0,NULL,&atx[4],NULL,0,&atx[67]} ,
  {0, "struc-comments" ,128,25,0,1,0,0,0,0,NULL,&atx[22],&atx[62],0,&atx[71]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[63],NULL,0,NULL} ,
  {408, "GBStrucComment" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[64],0,&atx[76]} ,
  ...
  {415, "GBStrucCommentItem" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[68],0,&atx[81]} ,
  ...
  {409, "GBFeature" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[77],0,&atx[101]} ,
  ...
  {416, "GBInterval" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[82],0,&atx[94]} ,
  ...
  {417, "GBQualifier" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[95],0,&atx[113]} ,
  ...
  {410, "GBFeatureSet" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[102],0,&atx[109]} ,
  ...
  {411, "GBAltSeqData" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[110],0,&atx[47]} ,
  ...
  {418, "GBAltSeqItem" ,1,0,0,0,0,0,0,0,NULL,&atx[50],&atx[114],0,NULL} ,
...
static AsnModule ampx[1] = {
  { "NCBI-GBSeq" , "asngbseq.h11",&atx[0],NULL,NULL,0,0} };
...
#define GBSEQ_struc_comments &at[61]
#define GBSEQ_struc_comments_E &at[62]
#define GBSEQ_primary &at[71]
#define GBSEQ_source_db &at[72]
#define GBSEQ_database_reference &at[73]
#define GBSEQ_feature_table &at[74]
#define GBSEQ_feature_table_E &at[75]
#define GBSEQ_feature_set &at[99]
#define GBSEQ_feature_set_E &at[100]
#define GBSEQ_sequence &at[105]
#define GBSEQ_contig &at[106]
#define GBSEQ_alt_seq &at[107]
#define GBSEQ_alt_seq_E &at[108]
#define GBSEQ_xrefs &at[123]
#define GBSEQ_xrefs_E &at[124]
...
#define GBSTRUCCOMMENT &at[63]
#define GBSTRUCCOMMENT_name &at[64]
#define GBSTRUCCOMMENT_items &at[65]
#define GBSTRUCCOMMENT_items_E &at[66]

#define GBFEATURE &at[76]
#define GBFEATURE_key &at[77]
#define GBFEATURE_location &at[78]
#define GBFEATURE_intervals &at[79]
#define GBFEATURE_intervals_E &at[80]
#define GBFEATURE_operator &at[89]
#define GBFEATURE_partial5 &at[90]
#define GBFEATURE_partial3 &at[91]
#define GBFEATURE_quals &at[92]
#define GBFEATURE_quals_E &at[93]
#define GBFEATURE_xrefs &at[97]
#define GBFEATURE_xrefs_E &at[98]

#define GBFEATURESET &at[101]
#define GBFEATURESET_annot_source &at[102]
#define GBFEATURESET_features &at[103]
#define GBFEATURESET_features_E &at[104]

#define GBALTSEQDATA &at[109]
#define GBALTSEQDATA_name &at[110]
#define GBALTSEQDATA_items &at[111]
#define GBALTSEQDATA_items_E &at[112]
...
#define GBSTRUCCOMMENTITEM &at[67]
#define GBSTRUCCOMMENTITEM_tag &at[68]
#define GBSTRUCCOMMENTITEM_value &at[69]
#define GBSTRUCCOMMENTITEM_url &at[70]

#define GBINTERVAL &at[81]
#define GBINTERVAL_from &at[82]
#define GBINTERVAL_to &at[83]
#define GBINTERVAL_point &at[84]
#define GBINTERVAL_iscomp &at[85]
#define GBINTERVAL_interbp &at[87]
#define GBINTERVAL_accession &at[88]

#define GBQUALIFIER &at[94]
#define GBQUALIFIER_name &at[95]
#define GBQUALIFIER_value &at[96]

#define GBALTSEQITEM &at[113]
#define GBALTSEQITEM_interval &at[114]
#define GBALTSEQITEM_isgap &at[115]
#define GBALTSEQITEM_gap_length &at[116]
#define GBALTSEQITEM_gap_type &at[117]
#define GBALTSEQITEM_gap_linkage &at[118]
#define GBALTSEQITEM_gap_comment &at[119]
#define GBALTSEQITEM_first_accn &at[120]
#define GBALTSEQITEM_last_accn &at[121]
#define GBALTSEQITEM_value &at[122]
