...
static AsnValxNode avnx[563] = {
    ...
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,0,0.0,NULL } ,
    {20,"iupacna" ,1,0.0,&avnx[492] } ,
    {20,"iupacaa" ,2,0.0,&avnx[493] } ,
    {20,"ncbi2na" ,3,0.0,&avnx[494] } ,
    {20,"ncbi4na" ,4,0.0,&avnx[495] } ,
    {20,"ncbi8na" ,5,0.0,&avnx[496] } ,
    {20,"ncbipna" ,6,0.0,&avnx[497] } ,
    {20,"ncbi8aa" ,7,0.0,&avnx[498] } ,
    {20,"ncbieaa" ,8,0.0,&avnx[499] } ,
    {20,"ncbipaa" ,9,0.0,&avnx[500] } ,
    {20,"iupacaa3" ,10,0.0,&avnx[501] } ,
    {20,"ncbistdaa" ,11,0.0,NULL } ,
    {3,NULL,0,0.0,NULL } ,
    {3,NULL,0,0.0,NULL } ,
    {2,NULL,0,0.0,NULL } ,
    {20,"new" ,1,0.0,&avnx[506] } ,
    {20,"update" ,2,0.0,&avnx[507] } ,
    {20,"revision" ,3,0.0,&avnx[508] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"off" ,1,0.0,&avnx[510] } ,
    {20,"trace" ,2,0.0,&avnx[511] } ,
    {20,"partial" ,3,0.0,&avnx[512] } ,
    {20,"complete" ,4,0.0,NULL } ,
    {20,"wire" ,1,0.0,&avnx[514] } ,
    {20,"tubes" ,2,0.0,&avnx[515] } ,
    {20,"ball-and-stick" ,3,0.0,&avnx[516] } ,
    {20,"space-fill" ,4,0.0,&avnx[517] } ,
    {20,"wire-worm" ,5,0.0,&avnx[518] } ,
    {20,"tube-worm" ,6,0.0,&avnx[519] } ,
    {20,"with-arrows" ,7,0.0,&avnx[520] } ,
    {20,"without-arrows" ,8,0.0,NULL } ,
    {20,"element" ,1,0.0,&avnx[522] } ,
    {20,"object" ,2,0.0,&avnx[523] } ,
    {20,"molecule" ,3,0.0,&avnx[524] } ,
    {20,"domain" ,4,0.0,&avnx[525] } ,
    {20,"secondary-structure" ,5,0.0,&avnx[526] } ,
    {20,"user-select" ,6,0.0,&avnx[527] } ,
    {20,"aligned" ,7,0.0,&avnx[528] } ,
    {20,"identity" ,8,0.0,&avnx[529] } ,
    {20,"variety" ,9,0.0,&avnx[530] } ,
    {20,"weighted-variety" ,10,0.0,&avnx[531] } ,
    {20,"information-content" ,11,0.0,&avnx[532] } ,
    {20,"fit" ,12,0.0,&avnx[533] } ,
    {20,"temperature" ,13,0.0,&avnx[534] } ,
    {20,"hydrophobicity" ,14,0.0,&avnx[535] } ,
    {20,"charge" ,15,0.0,&avnx[536] } ,
    {20,"rainbow" ,16,0.0,NULL } ,
    {3,NULL,255,0.0,NULL } ,
    {3,NULL,255,0.0,NULL } ,
    {20,"one-letter" ,1,0.0,&avnx[540] } ,
    {20,"three-letter" ,2,0.0,NULL } ,
    {20,"none" ,0,0.0,&avnx[542] } ,
    {20,"sequential" ,1,0.0,&avnx[543] } ,
    {20,"pdb" ,2,0.0,NULL } ,
    {20,"aa" ,1,0.0,&avnx[545] } ,
    {20,"na" ,2,0.0,&avnx[546] } ,
    {20,"both" ,3,0.0,NULL } ,
    {20,"docsum" ,1,0.0,&avnx[548] } ,
    {20,"genbank" ,2,0.0,&avnx[549] } ,
    {20,"genpept" ,3,0.0,&avnx[550] } ,
    {20,"fasta" ,4,0.0,&avnx[551] } ,
    {20,"asn1" ,5,0.0,&avnx[552] } ,
    {20,"graphic" ,6,0.0,&avnx[553] } ,
    {20,"alignment" ,7,0.0,&avnx[554] } ,
    {20,"globalview" ,8,0.0,&avnx[555] } ,
    {20,"report" ,9,0.0,&avnx[556] } ,
    {20,"medlars" ,10,0.0,&avnx[557] } ,
    {20,"embl" ,11,0.0,&avnx[558] } ,
    {20,"pdb" ,12,0.0,&avnx[559] } ,
    {20,"kinemage" ,13,0.0,NULL } ,
    {20,"ncbi-backbone" ,2,0.0,&avnx[561] } ,
    {20,"ncbi-all-atom" ,3,0.0,&avnx[562] } ,
...
static AsnType atx[1447] = {
  ...
  {0, "class" ,128,3,0,0,1,0,0,0,&avnx[490],&atx[42],&avnx[471],0,&atx[1048]} ,
  ...
  {404, "Seq-code-type" ,1,0,0,0,0,0,0,0,NULL,&atx[42],&avnx[491],0,NULL} ,
  {0, "num" ,128,1,0,0,0,0,0,0,NULL,&atx[6],NULL,0,&atx[1066]} ,
  {0, "one-letter" ,128,2,0,0,0,0,0,0,NULL,&atx[60],NULL,0,&atx[1067]} ,
  {0, "start-at" ,128,3,0,0,1,0,0,0,&avnx[502],&atx[6],NULL,0,&atx[1068]} ,
  ...
  {0, "start-at" ,128,3,0,0,1,0,0,0,&avnx[503],&atx[6],NULL,0,&atx[1079]} ,
  ...
  {0, "hup" ,128,2,0,0,1,0,0,0,&avnx[504],&atx[60],NULL,0,&atx[1113]} ,
  {0, "reldate" ,128,3,0,1,0,0,0,0,NULL,&atx[1114],NULL,0,&atx[1115]} ,
  {405, "Date" ,1,0,0,0,0,0,1,0,NULL,&atx[0],NULL,0,&atx[1103]} ,
  {0, "subtype" ,128,4,0,1,0,0,0,0,NULL,&atx[6],&avnx[505],0,&atx[1116]} ,
  ...
  {406, "Cn3d-backbone-type" ,1,0,0,0,0,0,0,0,NULL,&atx[42],&avnx[509],0,&atx[1138]} ,
  {0, "style" ,128,1,0,0,0,0,0,0,NULL,&atx[1138],NULL,0,&atx[1139]} ,
  {407, "Cn3d-drawing-style" ,1,0,0,0,0,0,0,0,NULL,&atx[42],&avnx[513],0,&atx[1140]} ,
  {0, "color-scheme" ,128,2,0,0,0,0,0,0,NULL,&atx[1140],NULL,0,&atx[1141]} ,
  {408, "Cn3d-color-scheme" ,1,0,0,0,0,0,0,0,NULL,&atx[42],&avnx[521],0,&atx[1142]} ,
  {0, "user-color" ,128,3,0,0,0,0,0,0,NULL,&atx[1142],NULL,0,NULL} ,
  {409, "Cn3d-color" ,1,0,0,0,0,0,0,0,NULL,&atx[13],&atx[1143],0,&atx[1134]} ,
  {0, "scale-factor" ,128,0,0,0,1,0,0,0,&avnx[537],&atx[6],NULL,0,&atx[1144]} ,
  ...
  {0, "alpha" ,128,4,0,0,1,0,0,0,&avnx[538],&atx[6],NULL,0,NULL} ,
  ...
  {0, "type" ,128,1,0,0,0,0,0,0,NULL,&atx[42],&avnx[539],0,&atx[1178]} ,
  {0, "number" ,128,2,0,0,0,0,0,0,NULL,&atx[42],&avnx[541],0,&atx[1179]} ,
  ...
  {405, "FeatMolType" ,1,0,0,0,0,0,0,0,NULL,&atx[42],&avnx[544],0,&atx[1332]} ,
  ...
  {417, "Entrez-style" ,1,0,0,0,0,0,0,0,NULL,&atx[42],&avnx[547],0,NULL} ,
  ...
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[1347],NULL,0,NULL} ,
  {0, "structure-type" ,128,2,0,1,0,0,0,0,NULL,&atx[42],&avnx[560],0,NULL} ,
