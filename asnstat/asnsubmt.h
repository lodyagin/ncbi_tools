...
static char * asnfilename = "asnsubmt.h60";
...
static AsnType atx[47] = {
  {401, "Seq-submit" ,1,0,0,0,0,1,0,0,NULL,&atx[23],&atx[1],0,&atx[25]} ,
  {0, "sub" ,128,0,0,0,0,0,0,0,NULL,&atx[2],NULL,0,&atx[35]} ,
  {409, "Submit-block" ,1,0,0,0,0,0,0,0,NULL,&atx[23],&atx[3],0,&atx[4]} ,
  {0, "contact" ,128,0,0,0,0,0,0,0,NULL,&atx[4],NULL,0,&atx[24]} ,
  {410, "Contact-info" ,1,0,0,0,0,0,0,0,NULL,&atx[23],&atx[5],0,NULL} ,
  ...
  {405, "Object-id" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[42]} ,
