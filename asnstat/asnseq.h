...
static char * asnfilename = "asnseq.h65";
static AsnValxNode avnx[144] = {
    ...
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,0,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[106] } ,
    {20,"virtual" ,1,0.0,&avnx[107] } ,
    {20,"raw" ,2,0.0,&avnx[108] } ,
    {20,"seg" ,3,0.0,&avnx[109] } ,
    {20,"const" ,4,0.0,&avnx[110] } ,
    {20,"ref" ,5,0.0,&avnx[111] } ,
    {20,"consen" ,6,0.0,&avnx[112] } ,
    {20,"map" ,7,0.0,&avnx[113] } ,
    {20,"delta" ,8,0.0,&avnx[114] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[116] } ,
    {20,"dna" ,1,0.0,&avnx[117] } ,
    {20,"rna" ,2,0.0,&avnx[118] } ,
    {20,"aa" ,3,0.0,&avnx[119] } ,
    {20,"na" ,4,0.0,&avnx[120] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[122] } ,
    {20,"linear" ,1,0.0,&avnx[123] } ,
    {20,"circular" ,2,0.0,&avnx[124] } ,
    {20,"tandem" ,3,0.0,&avnx[125] } ,
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,1,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[128] } ,
    {20,"ss" ,1,0.0,&avnx[129] } ,
    {20,"ds" ,2,0.0,&avnx[130] } ,
    {20,"mixed" ,3,0.0,&avnx[131] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"genbank" ,1,0.0,&avnx[133] } ,
    {20,"embl" ,2,0.0,&avnx[134] } ,
    {20,"ddbj" ,3,0.0,&avnx[135] } ,
    {20,"pir" ,4,0.0,&avnx[136] } ,
    {20,"sp" ,5,0.0,&avnx[137] } ,
    {20,"bbone" ,6,0.0,&avnx[138] } ,
    {20,"pdb" ,7,0.0,&avnx[139] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"ref" ,1,0.0,&avnx[141] } ,
    {20,"alt" ,2,0.0,&avnx[142] } ,
    {20,"blocks" ,3,0.0,&avnx[143] } ,
    {20,"other" ,255,0.0,NULL } };
...
static AsnType atx[206] = {
  ...
  {0, "completeness" ,128,3,0,0,1,0,0,0,&avnx[104],&atx[28],&avnx[97],0,NULL} ,
  {0, "inst" ,128,2,0,0,0,0,0,0,NULL,&atx[98],NULL,0,&atx[164]} ,
  {429, "Seq-inst" ,1,0,0,0,0,0,0,0,NULL,&atx[32],&atx[99],0,&atx[14]} ,
  {0, "repr" ,128,0,0,0,0,0,0,0,NULL,&atx[11],&avnx[105],0,&atx[100]} ,
  {0, "mol" ,128,1,0,0,0,0,0,0,NULL,&atx[11],&avnx[115],0,&atx[101]} ,
  ...
  {0, "topology" ,128,4,0,0,1,0,0,0,&avnx[126],&atx[11],&avnx[121],0,&atx[105]} ,
  {0, "strand" ,128,5,0,1,0,0,0,0,NULL,&atx[11],&avnx[127],0,&atx[106]} ,
  ...
  {0, "db" ,128,1,0,1,0,0,0,0,NULL,&atx[28],&avnx[132],0,&atx[175]} ,
  ...
  {0, "align-type" ,128,0,0,0,0,0,0,0,NULL,&atx[28],&avnx[140],0,&atx[191]} ,
...
static AsnModule ampx[1] = {
  { "NCBI-Sequence" , "asnseq.h65",&atx[0],NULL,NULL,0,0} };
