...
static char * asnfilename = "asnseq.h69";
static AsnValxNode avnx[147] = {
    {3,NULL,1,0.0,NULL } ,
    {2,NULL,0,0.0,NULL } ,
    {2,NULL,1,0.0,NULL } ,
    ...
    {20,"complete" ,1,0.0,&avnx[104] } ,
    {20,"partial" ,2,0.0,&avnx[105] } ,
    {20,"no-left" ,3,0.0,&avnx[106] } ,
    {20,"no-right" ,4,0.0,&avnx[107] } ,
    {20,"no-ends" ,5,0.0,&avnx[108] } ,
    {20,"has-left" ,6,0.0,&avnx[109] } ,
    {20,"has-right" ,7,0.0,&avnx[110] } ,
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,0,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[113] } ,
    {20,"virtual" ,1,0.0,&avnx[114] } ,
    {20,"raw" ,2,0.0,&avnx[115] } ,
    {20,"seg" ,3,0.0,&avnx[116] } ,
    {20,"const" ,4,0.0,&avnx[117] } ,
    {20,"ref" ,5,0.0,&avnx[118] } ,
    {20,"consen" ,6,0.0,&avnx[119] } ,
    {20,"map" ,7,0.0,&avnx[120] } ,
    {20,"delta" ,8,0.0,&avnx[121] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[123] } ,
    {20,"dna" ,1,0.0,&avnx[124] } ,
    {20,"rna" ,2,0.0,&avnx[125] } ,
    {20,"aa" ,3,0.0,&avnx[126] } ,
    {20,"na" ,4,0.0,&avnx[127] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[129] } ,
    {20,"linear" ,1,0.0,&avnx[130] } ,
    {20,"circular" ,2,0.0,&avnx[131] } ,
    {20,"tandem" ,3,0.0,&avnx[132] } ,
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,1,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[135] } ,
    {20,"ss" ,1,0.0,&avnx[136] } ,
    {20,"ds" ,2,0.0,&avnx[137] } ,
    {20,"mixed" ,3,0.0,&avnx[138] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"genbank" ,1,0.0,&avnx[140] } ,
    {20,"embl" ,2,0.0,&avnx[141] } ,
    {20,"ddbj" ,3,0.0,&avnx[142] } ,
    {20,"pir" ,4,0.0,&avnx[143] } ,
    {20,"sp" ,5,0.0,&avnx[144] } ,
    {20,"bbone" ,6,0.0,&avnx[145] } ,
    {20,"pdb" ,7,0.0,&avnx[146] } ,
    {20,"other" ,255,0.0,NULL } };
...
static AsnType atx[206] = {
  ...
  {0, "tech" ,128,1,0,0,1,0,0,0,&avnx[101],&atx[16],&avnx[78],0,&atx[111]} ,
  {0, "techexp" ,128,2,0,1,0,0,0,0,NULL,&atx[2],NULL,0,&atx[112]} ,
  {0, "completeness" ,128,3,0,0,1,0,0,0,&avnx[111],&atx[16],&avnx[102],0,NULL} ,
  {0, "inst" ,128,2,0,0,0,0,0,0,NULL,&atx[114],NULL,0,&atx[179]} ,
  {431, "Seq-inst" ,1,0,0,0,0,0,0,0,NULL,&atx[20],&atx[115],0,&atx[74]} ,
  {0, "repr" ,128,0,0,0,0,0,0,0,NULL,&atx[30],&avnx[112],0,&atx[116]} ,
  {0, "mol" ,128,1,0,0,0,0,0,0,NULL,&atx[30],&avnx[122],0,&atx[117]} ,
  ...
  {0, "topology" ,128,4,0,0,1,0,0,0,&avnx[133],&atx[30],&avnx[128],0,&atx[121]} ,
  {0, "strand" ,128,5,0,1,0,0,0,0,NULL,&atx[30],&avnx[134],0,&atx[122]} ,
  ...
  {0, "db" ,128,1,0,1,0,0,0,0,NULL,&atx[16],&avnx[139],0,&atx[190]} ,
...
static AsnModule ampx[1] = {
  { "NCBI-Sequence" , "asnseq.h69",&atx[0],NULL,NULL,0,0} };
