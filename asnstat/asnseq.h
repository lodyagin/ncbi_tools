...
static char * asnfilename = "asnseq.h63";
static AsnValxNode avnx[142] = {
    ...
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,0,0.0,NULL } ,
    {20,"unknown" ,0,0.0,&avnx[74] } ,
    {20,"standard" ,1,0.0,&avnx[75] } ,
    {20,"est" ,2,0.0,&avnx[76] } ,
    {20,"sts" ,3,0.0,&avnx[77] } ,
    {20,"survey" ,4,0.0,&avnx[78] } ,
    {20,"genemap" ,5,0.0,&avnx[79] } ,
    {20,"physmap" ,6,0.0,&avnx[80] } ,
    {20,"derived" ,7,0.0,&avnx[81] } ,
    {20,"concept-trans" ,8,0.0,&avnx[82] } ,
    {20,"seq-pept" ,9,0.0,&avnx[83] } ,
    {20,"both" ,10,0.0,&avnx[84] } ,
    {20,"seq-pept-overlap" ,11,0.0,&avnx[85] } ,
    {20,"seq-pept-homol" ,12,0.0,&avnx[86] } ,
    {20,"concept-trans-a" ,13,0.0,&avnx[87] } ,
    {20,"htgs-1" ,14,0.0,&avnx[88] } ,
    {20,"htgs-2" ,15,0.0,&avnx[89] } ,
    {20,"htgs-3" ,16,0.0,&avnx[90] } ,
    {20,"fli-cdna" ,17,0.0,&avnx[91] } ,
    {20,"htgs-0" ,18,0.0,&avnx[92] } ,
    {20,"htc" ,19,0.0,&avnx[93] } ,
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,0,0.0,NULL } ,
    {20,"unknown" ,0,0.0,&avnx[96] } ,
    {20,"complete" ,1,0.0,&avnx[97] } ,
    {20,"partial" ,2,0.0,&avnx[98] } ,
    {20,"no-left" ,3,0.0,&avnx[99] } ,
    {20,"no-right" ,4,0.0,&avnx[100] } ,
    {20,"no-ends" ,5,0.0,&avnx[101] } ,
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,0,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[104] } ,
    {20,"virtual" ,1,0.0,&avnx[105] } ,
    {20,"raw" ,2,0.0,&avnx[106] } ,
    {20,"seg" ,3,0.0,&avnx[107] } ,
    {20,"const" ,4,0.0,&avnx[108] } ,
    {20,"ref" ,5,0.0,&avnx[109] } ,
    {20,"consen" ,6,0.0,&avnx[110] } ,
    {20,"map" ,7,0.0,&avnx[111] } ,
    {20,"delta" ,8,0.0,&avnx[112] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[114] } ,
    {20,"dna" ,1,0.0,&avnx[115] } ,
    {20,"rna" ,2,0.0,&avnx[116] } ,
    {20,"aa" ,3,0.0,&avnx[117] } ,
    {20,"na" ,4,0.0,&avnx[118] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[120] } ,
    {20,"linear" ,1,0.0,&avnx[121] } ,
    {20,"circular" ,2,0.0,&avnx[122] } ,
    {20,"tandem" ,3,0.0,&avnx[123] } ,
    {20,"other" ,255,0.0,NULL } ,
    {3,NULL,1,0.0,NULL } ,
    {20,"not-set" ,0,0.0,&avnx[126] } ,
    {20,"ss" ,1,0.0,&avnx[127] } ,
    {20,"ds" ,2,0.0,&avnx[128] } ,
    {20,"mixed" ,3,0.0,&avnx[129] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"genbank" ,1,0.0,&avnx[131] } ,
    {20,"embl" ,2,0.0,&avnx[132] } ,
    {20,"ddbj" ,3,0.0,&avnx[133] } ,
    {20,"pir" ,4,0.0,&avnx[134] } ,
    {20,"sp" ,5,0.0,&avnx[135] } ,
    {20,"bbone" ,6,0.0,&avnx[136] } ,
    {20,"pdb" ,7,0.0,&avnx[137] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"ref" ,1,0.0,&avnx[139] } ,
    {20,"alt" ,2,0.0,&avnx[140] } ,
    {20,"blocks" ,3,0.0,&avnx[141] } ,
    {20,"other" ,255,0.0,NULL } };
...
static AsnType atx[206] = {
  ...
  {0, "biomol" ,128,0,0,0,1,0,0,0,&avnx[72],&atx[28],&avnx[58],0,&atx[94]} ,
  {0, "tech" ,128,1,0,0,1,0,0,0,&avnx[94],&atx[28],&avnx[73],0,&atx[95]} ,
  {0, "techexp" ,128,2,0,1,0,0,0,0,NULL,&atx[18],NULL,0,&atx[96]} ,
  {0, "completeness" ,128,3,0,0,1,0,0,0,&avnx[102],&atx[28],&avnx[95],0,NULL} ,
  {0, "inst" ,128,2,0,0,0,0,0,0,NULL,&atx[98],NULL,0,&atx[164]} ,
  {429, "Seq-inst" ,1,0,0,0,0,0,0,0,NULL,&atx[32],&atx[99],0,&atx[14]} ,
  {0, "repr" ,128,0,0,0,0,0,0,0,NULL,&atx[11],&avnx[103],0,&atx[100]} ,
  {0, "mol" ,128,1,0,0,0,0,0,0,NULL,&atx[11],&avnx[113],0,&atx[101]} ,
  ...
  {0, "topology" ,128,4,0,0,1,0,0,0,&avnx[124],&atx[11],&avnx[119],0,&atx[105]} ,
  {0, "strand" ,128,5,0,1,0,0,0,0,NULL,&atx[11],&avnx[125],0,&atx[106]} ,
  ...
  {0, "db" ,128,1,0,1,0,0,0,0,NULL,&atx[28],&avnx[130],0,&atx[175]} ,
  ...
  {0, "align-type" ,128,0,0,0,0,0,0,0,NULL,&atx[28],&avnx[138],0,&atx[191]} ,
...
static AsnModule ampx[1] = {
  { "NCBI-Sequence" , "asnseq.h63",&atx[0],NULL,NULL,0,0} };
