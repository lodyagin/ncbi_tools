...
static char * asnfilename = "asnfeat.h35";
static AsnValxNode avnx[375] = {
    {2,NULL,0,0.0,NULL } ,
    ...
    {20,"untested" ,1,0.0,&avnx[236] } ,
    {20,"non-pathogenic" ,2,0.0,&avnx[237] } ,
    {20,"probable-non-pathogenic" ,3,0.0,&avnx[238] } ,
    {20,"probable-pathogenic" ,4,0.0,&avnx[239] } ,
    {20,"pathogenic" ,5,0.0,&avnx[240] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"unknown" ,0,0.0,&avnx[242] } ,
    {20,"bac-acgh" ,1,0.0,&avnx[243] } ,
    {20,"computational" ,2,0.0,&avnx[244] } ,
    {20,"curated" ,3,0.0,&avnx[245] } ,
    {20,"digital-array" ,4,0.0,&avnx[246] } ,
    {20,"expression-array" ,5,0.0,&avnx[247] } ,
    {20,"fish" ,6,0.0,&avnx[248] } ,
    {20,"flanking-sequence" ,7,0.0,&avnx[249] } ,
    {20,"maph" ,8,0.0,&avnx[250] } ,
    {20,"mcd-analysis" ,9,0.0,&avnx[251] } ,
    {20,"mlpa" ,10,0.0,&avnx[252] } ,
    {20,"oea-assembly" ,11,0.0,&avnx[253] } ,
    {20,"oligo-acgh" ,12,0.0,&avnx[254] } ,
    {20,"paired-end" ,13,0.0,&avnx[255] } ,
    {20,"pcr" ,14,0.0,&avnx[256] } ,
    {20,"qpcr" ,15,0.0,&avnx[257] } ,
    {20,"read-depth" ,16,0.0,&avnx[258] } ,
    {20,"roma" ,17,0.0,&avnx[259] } ,
    {20,"rt-pcr" ,18,0.0,&avnx[260] } ,
    {20,"sage" ,19,0.0,&avnx[261] } ,
    {20,"sequence-alignment" ,20,0.0,&avnx[262] } ,
    {20,"sequencing" ,21,0.0,&avnx[263] } ,
    {20,"snp-array" ,22,0.0,&avnx[264] } ,
    {20,"snp-genoytyping" ,23,0.0,&avnx[265] } ,
    {20,"southern" ,24,0.0,&avnx[266] } ,
    {20,"western" ,25,0.0,&avnx[267] } ,
    {20,"optical-mapping" ,26,0.0,&avnx[268] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"preserved" ,1,0.0,&avnx[270] } ,
    {20,"provisional" ,2,0.0,&avnx[271] } ,
    {20,"has3D" ,4,0.0,&avnx[272] } ,
    {20,"submitterLinkout" ,8,0.0,&avnx[273] } ,
    {20,"clinical" ,16,0.0,&avnx[274] } ,
    {20,"genotypeKit" ,32,0.0,NULL } ,
    {20,"in-gene" ,1,0.0,&avnx[276] } ,
    {20,"near-gene-5" ,2,0.0,&avnx[277] } ,
    {20,"near-gene-3" ,4,0.0,&avnx[278] } ,
    {20,"intron" ,8,0.0,&avnx[279] } ,
    {20,"donor" ,16,0.0,&avnx[280] } ,
    {20,"acceptor" ,32,0.0,&avnx[281] } ,
    {20,"utr-5" ,64,0.0,&avnx[282] } ,
    {20,"utr-3" ,128,0.0,&avnx[283] } ,
    {20,"in-start-codon" ,256,0.0,&avnx[284] } ,
    {20,"in-stop-codon" ,512,0.0,&avnx[285] } ,
    {20,"intergenic" ,1024,0.0,&avnx[286] } ,
    {20,"conserved-noncoding" ,2048,0.0,NULL } ,
    {20,"no-change" ,0,0.0,&avnx[288] } ,
    {20,"synonymous" ,1,0.0,&avnx[289] } ,
    {20,"nonsense" ,2,0.0,&avnx[290] } ,
    {20,"missense" ,4,0.0,&avnx[291] } ,
    {20,"frameshift" ,8,0.0,&avnx[292] } ,
    {20,"up-regulator" ,16,0.0,&avnx[293] } ,
    {20,"down-regulator" ,32,0.0,&avnx[294] } ,
    {20,"methylation" ,64,0.0,NULL } ,
    {20,"has-other-snp" ,1,0.0,&avnx[296] } ,
    {20,"has-assembly-conflict" ,2,0.0,&avnx[297] } ,
    {20,"is-assembly-specific" ,4,0.0,NULL } ,
    {20,"is-uniquely-placed" ,1,0.0,&avnx[299] } ,
    {20,"placed-twice-on-same-chrom" ,2,0.0,&avnx[300] } ,
    {20,"placed-twice-on-diff-chrom" ,3,0.0,&avnx[301] } ,
    {20,"many-placements" ,10,0.0,NULL } ,
    {20,"is-mutation" ,1,0.0,&avnx[303] } ,
    {20,"above-5pct-all" ,2,0.0,&avnx[304] } ,
    {20,"above-5pct-1plus" ,4,0.0,&avnx[305] } ,
    {20,"validated" ,8,0.0,&avnx[306] } ,
    {20,"above-1pct-all" ,16,0.0,&avnx[307] } ,
    {20,"above-1pct-1plus" ,32,0.0,NULL } ,
    {20,"in-haplotype-set" ,1,0.0,&avnx[309] } ,
    {20,"has-genotypes" ,2,0.0,NULL } ,
    {20,"contig-allele-missing" ,1,0.0,&avnx[311] } ,
    {20,"withdrawn-by-submitter" ,2,0.0,&avnx[312] } ,
    {20,"non-overlapping-alleles" ,4,0.0,&avnx[313] } ,
    {20,"strain-specific" ,8,0.0,&avnx[314] } ,
    {20,"genotype-conflict" ,16,0.0,NULL } ,
    {20,"unknown" ,0,0.0,&avnx[316] } ,
    {20,"likely-artifact" ,1,0.0,&avnx[317] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"unknown" ,0,0.0,&avnx[319] } ,
    {20,"germline" ,1,0.0,&avnx[320] } ,
    {20,"somatic" ,2,0.0,&avnx[321] } ,
    {20,"inherited" ,3,0.0,&avnx[322] } ,
    {20,"paternal" ,4,0.0,&avnx[323] } ,
    {20,"maternal" ,5,0.0,&avnx[324] } ,
    {20,"de-novo" ,6,0.0,&avnx[325] } ,
    {20,"biparental" ,7,0.0,&avnx[326] } ,
    {20,"uniparental" ,8,0.0,&avnx[327] } ,
    {20,"not-tested" ,9,0.0,&avnx[328] } ,
    {20,"tested-inconclusive" ,10,0.0,&avnx[329] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"unknown" ,0,0.0,&avnx[331] } ,
    {20,"homozygous" ,1,0.0,&avnx[332] } ,
    {20,"heterozygous" ,2,0.0,&avnx[333] } ,
    {20,"hemizygous" ,3,0.0,&avnx[334] } ,
    {20,"nullizygous" ,4,0.0,&avnx[335] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"unknown" ,0,0.0,&avnx[337] } ,
    {20,"identity" ,1,0.0,&avnx[338] } ,
    {20,"inv" ,2,0.0,&avnx[339] } ,
    {20,"snv" ,3,0.0,&avnx[340] } ,
    {20,"mnp" ,4,0.0,&avnx[341] } ,
    {20,"delins" ,5,0.0,&avnx[342] } ,
    {20,"del" ,6,0.0,&avnx[343] } ,
    {20,"ins" ,7,0.0,&avnx[344] } ,
    {20,"microsatellite" ,8,0.0,&avnx[345] } ,
    {20,"transposon" ,9,0.0,&avnx[346] } ,
    {20,"cnv" ,10,0.0,&avnx[347] } ,
    {20,"direct-copy" ,11,0.0,&avnx[348] } ,
    {20,"rev-direct-copy" ,12,0.0,&avnx[349] } ,
    {20,"inverted-copy" ,13,0.0,&avnx[350] } ,
    {20,"everted-copy" ,14,0.0,&avnx[351] } ,
    {20,"translocation" ,15,0.0,&avnx[352] } ,
    {20,"prot-missense" ,16,0.0,&avnx[353] } ,
    {20,"prot-nonsense" ,17,0.0,&avnx[354] } ,
    {20,"prot-neutral" ,18,0.0,&avnx[355] } ,
    {20,"prot-silent" ,19,0.0,&avnx[356] } ,
    {20,"prot-other" ,20,0.0,&avnx[357] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"morph" ,0,0.0,&avnx[359] } ,
    {20,"offset" ,1,0.0,&avnx[360] } ,
    {20,"del-at" ,2,0.0,&avnx[361] } ,
    {20,"ins-before" ,3,0.0,NULL } ,
    {3,NULL,0,0.0,NULL } ,
    {20,"unknown" ,0,0.0,&avnx[364] } ,
    {20,"compound" ,1,0.0,&avnx[365] } ,
    {20,"products" ,2,0.0,&avnx[366] } ,
    {20,"haplotype" ,3,0.0,&avnx[367] } ,
    {20,"genotype" ,4,0.0,&avnx[368] } ,
    {20,"mosaic" ,5,0.0,&avnx[369] } ,
    {20,"individual" ,6,0.0,&avnx[370] } ,
    {20,"population" ,7,0.0,&avnx[371] } ,
    {20,"alleles" ,8,0.0,&avnx[372] } ,
    {20,"other" ,255,0.0,NULL } ,
    {20,"experimental" ,1,0.0,&avnx[374] } ,
...
static AsnType atx[387] = {
  ...
  {411, "Giimport-id" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[156]} ,
  {0, "local" ,128,2,0,0,0,0,0,0,NULL,&atx[8],NULL,0,&atx[9]} ,
  {418, "Object-id" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[10]} ,
  {0, "general" ,128,3,0,0,0,0,0,0,NULL,&atx[10],NULL,0,NULL} ,
  {419, "Dbtag" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[175]} ,
  {315, "CHOICE" ,0,-1,0,0,0,0,0,0,NULL,NULL,NULL,0,NULL} ,
  {0, "data" ,128,1,0,0,0,0,0,0,NULL,&atx[13],NULL,0,&atx[357]} ,
  {421, "SeqFeatData" ,1,0,0,0,0,0,0,0,NULL,&atx[11],&atx[14],0,&atx[364]} ,
  {0, "gene" ,128,0,0,0,0,0,0,0,NULL,&atx[15],NULL,0,&atx[39]} ,
  {404, "Gene-ref" ,1,0,0,0,0,0,1,0,NULL,&atx[16],NULL,0,&atx[114]} ,
  ...
  {406, "Org-ref" ,1,0,0,0,0,0,1,0,NULL,&atx[41],NULL,0,&atx[255]} ,
  ...
  {424, "Cdregion" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[86],0,&atx[159]} ,
  ...
  {403, "Genetic-code" ,1,0,0,0,0,1,0,0,NULL,&atx[27],&atx[93],0,&atx[15]} ,
  ...
  {427, "Code-break" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[106],0,&atx[385]} ,
  {0, "loc" ,128,0,0,0,0,0,0,0,NULL,&atx[107],NULL,0,&atx[108]} ,
  {410, "Seq-loc" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[6]} ,
  ...
  {405, "Prot-ref" ,1,0,0,0,0,0,1,0,NULL,&atx[115],NULL,0,&atx[40]} ,
  ...
  {409, "RNA-ref" ,1,0,0,0,0,0,1,0,NULL,&atx[129],NULL,0,&atx[107]} ,
  ...
  {412, "Pubdesc" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[206]} ,
  {0, "seq" ,128,6,0,0,0,0,0,0,NULL,&atx[107],NULL,0,&atx[158]} ,
  {0, "imp" ,128,7,0,0,0,0,0,0,NULL,&atx[159],NULL,0,&atx[163]} ,
  {425, "Imp-feat" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[160],0,&atx[239]} ,
  ...
  {415, "Rsite-ref" ,1,0,0,0,0,0,1,0,NULL,&atx[170],NULL,0,&atx[177]} ,
  ...
  {420, "User-object" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[13]} ,
  {0, "txinit" ,128,14,0,0,0,0,0,0,NULL,&atx[177],NULL,0,&atx[205]} ,
  {416, "Txinit" ,1,0,0,0,0,0,1,0,NULL,&atx[178],NULL,0,&atx[370]} ,
  ...
  {413, "Numbering" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[210]} ,
  ...
  {414, "Heterogen" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[169]} ,
  {0, "biosrc" ,128,19,0,0,0,0,0,0,NULL,&atx[212],NULL,0,&atx[238]} ,
  {408, "BioSource" ,1,0,0,0,0,0,1,0,NULL,&atx[213],NULL,0,&atx[128]} ,
  {401, "BioSource" ,1,0,0,0,0,1,0,0,NULL,&atx[38],&atx[214],0,&atx[217]} ,
  ...
  {402, "Org-ref" ,1,0,0,0,0,0,1,0,NULL,&atx[41],NULL,0,&atx[220]} ,
  {0, "subtype" ,128,3,0,1,0,0,0,0,NULL,&atx[63],&atx[219],0,&atx[224]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[220],NULL,0,NULL} ,
  {403, "SubSource" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[221],0,&atx[226]} ,
  ...
  {426, "Clone-ref" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[240],0,&atx[105]} ,
  {0, "name" ,128,0,0,0,0,0,0,0,NULL,&atx[18],NULL,0,&atx[241]} ,
  {0, "library" ,128,1,0,1,0,0,0,0,NULL,&atx[18],NULL,0,&atx[242]} ,
  {0, "concordant" ,128,2,0,0,1,0,0,0,&avnx[215],&atx[23],NULL,0,&atx[243]} ,
  {0, "unique" ,128,3,0,0,1,0,0,0,&avnx[216],&atx[23],NULL,0,&atx[244]} ,
  {0, "placement-method" ,128,4,0,1,0,0,0,0,NULL,&atx[4],&avnx[217],0,&atx[245]} ,
  {0, "clone-seq" ,128,5,0,1,0,0,0,0,NULL,&atx[246],NULL,0,NULL} ,
  {429, "Clone-seq-set" ,1,0,0,0,0,0,0,0,NULL,&atx[27],&atx[247],0,&atx[248]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[248],NULL,0,NULL} ,
  {430, "Clone-seq" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[249],0,NULL} ,
  {0, "type" ,128,0,0,0,0,0,0,0,NULL,&atx[4],&avnx[223],0,&atx[250]} ,
  {0, "confidence" ,128,1,0,1,0,0,0,0,NULL,&atx[4],&avnx[226],0,&atx[251]} ,
  ...
  {407, "Variation-ref" ,1,0,0,0,0,0,1,0,NULL,&atx[256],NULL,0,&atx[212]} ,
  {401, "Variation-ref" ,1,0,0,0,0,1,0,0,NULL,&atx[38],&atx[257],0,&atx[317]} ,
  {0, "id" ,128,0,0,1,0,0,0,0,NULL,&atx[258],NULL,0,&atx[259]} ,
  {406, "Dbtag" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[324]} ,
  ...
  {411, "Phenotype" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[271],0,&atx[280]} ,
  ...
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[258],NULL,0,NULL} ,
  {0, "clinical-significance" ,128,3,0,1,0,0,0,0,NULL,&atx[4],&avnx[234],0,NULL} ,
  {0, "method" ,128,8,0,1,0,0,0,0,NULL,&atx[27],&atx[277],0,&atx[278]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[4],&avnx[241],0,NULL} ,
  {0, "population-data" ,128,9,0,1,0,0,0,0,NULL,&atx[27],&atx[279],0,&atx[287]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[280],NULL,0,NULL} ,
  {412, "Population-data" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[281],0,&atx[352]} ,
  ...
  {0, "variant-prop" ,128,10,0,1,0,0,0,0,NULL,&atx[288],NULL,0,&atx[303]} ,
  {410, "VariantProperties" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[289],0,&atx[270]} ,
  {0, "version" ,128,0,0,0,0,0,0,0,NULL,&atx[4],NULL,0,&atx[290]} ,
  {0, "resource-link" ,128,1,0,1,0,0,0,0,NULL,&atx[4],&avnx[269],0,&atx[291]} ,
  {0, "gene-location" ,128,2,0,1,0,0,0,0,NULL,&atx[4],&avnx[275],0,&atx[292]} ,
  {0, "effect" ,128,3,0,1,0,0,0,0,NULL,&atx[4],&avnx[287],0,&atx[293]} ,
  {0, "mapping" ,128,4,0,1,0,0,0,0,NULL,&atx[4],&avnx[295],0,&atx[294]} ,
  {0, "map-weight" ,128,5,0,1,0,0,0,0,NULL,&atx[4],&avnx[298],0,&atx[295]} ,
  {0, "frequency-based-validation" ,128,6,0,1,0,0,0,0,NULL,&atx[4],&avnx[302],0,&atx[296]} ,
  {0, "genotype" ,128,7,0,1,0,0,0,0,NULL,&atx[4],&avnx[308],0,&atx[297]} ,
  {0, "project-data" ,128,8,0,1,0,0,0,0,NULL,&atx[27],&atx[298],0,&atx[301]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[38],&atx[299],0,NULL} ,
  {0, "project-ids" ,128,0,0,0,0,0,0,0,NULL,&atx[27],&atx[300],0,NULL} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[4],NULL,0,NULL} ,
  {0, "quality-check" ,128,9,0,1,0,0,0,0,NULL,&atx[4],&avnx[310],0,&atx[302]} ,
  {0, "confidence" ,128,10,0,1,0,0,0,0,NULL,&atx[4],&avnx[315],0,NULL} ,
  {0, "validated" ,128,11,0,1,0,0,0,0,NULL,&atx[23],NULL,0,&atx[304]} ,
  {0, "clinical-test" ,128,12,0,1,0,0,0,0,NULL,&atx[27],&atx[305],0,&atx[306]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[258],NULL,0,NULL} ,
  {0, "allele-origin" ,128,13,0,1,0,0,0,0,NULL,&atx[4],&avnx[318],0,&atx[307]} ,
  {0, "allele-state" ,128,14,0,1,0,0,0,0,NULL,&atx[4],&avnx[330],0,&atx[308]} ,
  {0, "allele-frequency" ,128,15,0,1,0,0,0,0,NULL,&atx[283],NULL,0,&atx[309]} ,
  {0, "is-ancestral-allele" ,128,16,0,1,0,0,0,0,NULL,&atx[23],NULL,0,&atx[310]} ,
  {0, "pub" ,128,17,0,1,0,0,0,0,NULL,&atx[311],NULL,0,&atx[312]} ,
  {409, "Pub" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[288]} ,
  {0, "data" ,128,18,0,0,0,0,0,0,NULL,&atx[11],&atx[313],0,&atx[337]} ,
  {0, "unknown" ,128,0,0,0,0,0,0,0,NULL,&atx[165],NULL,0,&atx[314]} ,
  {0, "note" ,128,1,0,0,0,0,0,0,NULL,&atx[18],NULL,0,&atx[315]} ,
  {0, "uniparental-disomy" ,128,2,0,0,0,0,0,0,NULL,&atx[165],NULL,0,&atx[316]} ,
  {0, "instance" ,128,3,0,0,0,0,0,0,NULL,&atx[317],NULL,0,&atx[332]} ,
  {402, "Variation-inst" ,1,0,0,0,0,1,0,0,NULL,&atx[38],&atx[318],0,&atx[330]} ,
  {0, "type" ,128,0,0,0,0,0,0,0,NULL,&atx[4],&avnx[336],0,&atx[319]} ,
  {0, "delta" ,128,1,0,0,0,0,0,0,NULL,&atx[63],&atx[320],0,NULL} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[321],NULL,0,NULL} ,
  {414, "Delta-item" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[322],0,NULL} ,
  {0, "seq" ,128,0,0,1,0,0,0,0,NULL,&atx[11],&atx[323],0,&atx[328]} ,
  {0, "literal" ,128,0,0,0,0,0,0,0,NULL,&atx[324],NULL,0,&atx[325]} ,
  {407, "Seq-literal" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[326]} ,
  {0, "loc" ,128,1,0,0,0,0,0,0,NULL,&atx[326],NULL,0,&atx[327]} ,
  {408, "Seq-loc" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[311]} ,
  {0, "this" ,128,2,0,0,0,0,0,0,NULL,&atx[165],NULL,0,NULL} ,
  {0, "multiplier" ,128,1,0,1,0,0,0,0,NULL,&atx[4],NULL,0,&atx[329]} ,
  {0, "multiplier-fuzz" ,128,2,0,1,0,0,0,0,NULL,&atx[330],NULL,0,&atx[331]} ,
  {403, "Int-fuzz" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[356]} ,
  {0, "action" ,128,3,0,0,1,0,0,0,&avnx[362],&atx[4],&avnx[358],0,NULL} ,
  {0, "set" ,128,4,0,0,0,0,0,0,NULL,&atx[38],&atx[333],0,NULL} ,
  {0, "type" ,128,0,0,0,0,0,0,0,NULL,&atx[4],&avnx[363],0,&atx[334]} ,
  {0, "variations" ,128,1,0,0,0,0,0,0,NULL,&atx[27],&atx[335],0,&atx[336]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[256],NULL,0,NULL} ,
  {0, "name" ,128,2,0,1,0,0,0,0,NULL,&atx[18],NULL,0,NULL} ,
  {0, "consequence" ,128,19,0,1,0,0,0,0,NULL,&atx[27],&atx[338],0,&atx[349]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[11],&atx[339],0,NULL} ,
  {0, "unknown" ,128,0,0,0,0,0,0,0,NULL,&atx[165],NULL,0,&atx[340]} ,
  {0, "splicing" ,128,1,0,0,0,0,0,0,NULL,&atx[165],NULL,0,&atx[341]} ,
  {0, "note" ,128,2,0,0,0,0,0,0,NULL,&atx[18],NULL,0,&atx[342]} ,
  {0, "variation" ,128,3,0,0,0,0,0,0,NULL,&atx[256],NULL,0,&atx[343]} ,
  {0, "frameshift" ,128,4,0,0,0,0,0,0,NULL,&atx[38],&atx[344],0,&atx[346]} ,
  {0, "phase" ,128,0,0,1,0,0,0,0,NULL,&atx[4],NULL,0,&atx[345]} ,
  {0, "x-length" ,128,1,0,1,0,0,0,0,NULL,&atx[4],NULL,0,NULL} ,
  {0, "loss-of-heterozygosity" ,128,5,0,0,0,0,0,0,NULL,&atx[38],&atx[347],0,NULL} ,
  {0, "reference" ,128,0,0,1,0,0,0,0,NULL,&atx[18],NULL,0,&atx[348]} ,
  {0, "test" ,128,1,0,1,0,0,0,0,NULL,&atx[18],NULL,0,NULL} ,
  {0, "location" ,128,20,0,1,0,0,0,0,NULL,&atx[326],NULL,0,&atx[350]} ,
  {0, "ext-locs" ,128,21,0,1,0,0,0,0,NULL,&atx[27],&atx[351],0,&atx[355]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[352],NULL,0,NULL} ,
  {413, "Ext-loc" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[353],0,&atx[321]} ,
  {0, "id" ,128,0,0,0,0,0,0,0,NULL,&atx[261],NULL,0,&atx[354]} ,
  {0, "location" ,128,1,0,0,0,0,0,0,NULL,&atx[326],NULL,0,NULL} ,
  {0, "ext" ,128,22,0,1,0,0,0,0,NULL,&atx[356],NULL,0,NULL} ,
  {404, "User-object" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[261]} ,
  {0, "partial" ,128,2,0,1,0,0,0,0,NULL,&atx[23],NULL,0,&atx[358]} ,
  {0, "except" ,128,3,0,1,0,0,0,0,NULL,&atx[23],NULL,0,&atx[359]} ,
  {0, "comment" ,128,4,0,1,0,0,0,0,NULL,&atx[18],NULL,0,&atx[360]} ,
  {0, "product" ,128,5,0,1,0,0,0,0,NULL,&atx[107],NULL,0,&atx[361]} ,
  {0, "location" ,128,6,0,0,0,0,0,0,NULL,&atx[107],NULL,0,&atx[362]} ,
  {0, "qual" ,128,7,0,1,0,0,0,0,NULL,&atx[63],&atx[363],0,&atx[367]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[364],NULL,0,NULL} ,
  {422, "Gb-qual" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[365],0,&atx[374]} ,
  {0, "qual" ,128,0,0,0,0,0,0,0,NULL,&atx[18],NULL,0,&atx[366]} ,
  {0, "val" ,128,1,0,0,0,0,0,0,NULL,&atx[18],NULL,0,NULL} ,
  {0, "title" ,128,8,0,1,0,0,0,0,NULL,&atx[18],NULL,0,&atx[368]} ,
  {0, "ext" ,128,9,0,1,0,0,0,0,NULL,&atx[175],NULL,0,&atx[369]} ,
  {0, "cit" ,128,10,0,1,0,0,0,0,NULL,&atx[370],NULL,0,&atx[371]} ,
  {417, "Pub-set" ,1,0,0,0,0,0,1,0,NULL,NULL,NULL,0,&atx[8]} ,
  {0, "exp-ev" ,128,11,0,1,0,0,0,0,NULL,&atx[34],&avnx[373],0,&atx[372]} ,
  {0, "xref" ,128,12,0,1,0,0,0,0,NULL,&atx[27],&atx[373],0,&atx[377]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[374],NULL,0,NULL} ,
  {423, "SeqFeatXref" ,1,0,0,0,0,0,0,0,NULL,&atx[38],&atx[375],0,&atx[85]} ,
  {0, "id" ,128,0,0,1,0,0,0,0,NULL,&atx[2],NULL,0,&atx[376]} ,
  {0, "data" ,128,1,0,1,0,0,0,0,NULL,&atx[13],NULL,0,NULL} ,
  {0, "dbxref" ,128,13,0,1,0,0,0,0,NULL,&atx[27],&atx[378],0,&atx[379]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[10],NULL,0,NULL} ,
  {0, "pseudo" ,128,14,0,1,0,0,0,0,NULL,&atx[23],NULL,0,&atx[380]} ,
  {0, "except-text" ,128,15,0,1,0,0,0,0,NULL,&atx[18],NULL,0,&atx[381]} ,
  {0, "ids" ,128,16,0,1,0,0,0,0,NULL,&atx[27],&atx[382],0,&atx[383]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[2],NULL,0,NULL} ,
  {0, "exts" ,128,17,0,1,0,0,0,0,NULL,&atx[27],&atx[384],0,NULL} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[175],NULL,0,NULL} ,
  {428, "Genetic-code-table" ,1,0,0,0,0,0,0,0,NULL,&atx[27],&atx[386],0,&atx[246]} ,
  {0, NULL,1,-1,0,0,0,0,0,0,NULL,&atx[92],NULL,0,NULL} };

static AsnModule ampx[9] = {
  { "NCBI-Seqfeat" , "asnfeat.h35",&atx[0],NULL,&ampx[1],0,0} ,
...
#define SEQ_FEAT_partial &at[357]
#define SEQ_FEAT_except &at[358]
#define SEQ_FEAT_comment &at[359]
#define SEQ_FEAT_product &at[360]
#define SEQ_FEAT_location &at[361]
#define SEQ_FEAT_qual &at[362]
#define SEQ_FEAT_qual_E &at[363]
#define SEQ_FEAT_title &at[367]
#define SEQ_FEAT_ext &at[368]
#define SEQ_FEAT_cit &at[369]
#define SEQ_FEAT_exp_ev &at[371]
#define SEQ_FEAT_xref &at[372]
#define SEQ_FEAT_xref_E &at[373]
#define SEQ_FEAT_dbxref &at[377]
#define SEQ_FEAT_dbxref_E &at[378]
#define SEQ_FEAT_pseudo &at[379]
#define SEQ_FEAT_except_text &at[380]
#define SEQ_FEAT_ids &at[381]
#define SEQ_FEAT_ids_E &at[382]
#define SEQ_FEAT_exts &at[383]
#define SEQ_FEAT_exts_E &at[384]
...
#define GB_QUAL &at[364]
#define GB_QUAL_qual &at[365]
#define GB_QUAL_val &at[366]

#define SEQFEATXREF &at[374]
#define SEQFEATXREF_id &at[375]
#define SEQFEATXREF_data &at[376]
...
#define GENETIC_CODE_TABLE &at[385]
#define GENETIC_CODE_TABLE_E &at[386]
...
#define VARIATION_REF_validated &at[303]
#define VARIATION_REF_clinical_test &at[304]
#define VARIATION_REF_clinical_test_E &at[305]
#define VARIATION_REF_allele_origin &at[306]
#define VARIATION_REF_allele_state &at[307]
#define VARIATION_REF_allele_frequency &at[308]
#define REF_is_ancestral_allele &at[309]
#define VARIATION_REF_pub &at[310]
#define VARIATION_REF_data &at[312]
#define VARIATION_REF_data_unknown &at[313]
#define VARIATION_REF_data_note &at[314]
#define REF_data_uniparental_disomy &at[315]
#define VARIATION_REF_data_instance &at[316]
#define VARIATION_REF_data_set &at[332]
#define VARIATION_REF_data_set_type &at[333]
#define REF_data_set_variations &at[334]
#define REF_data_set_variations_E &at[335]
#define VARIATION_REF_data_set_name &at[336]
#define VARIATION_REF_consequence &at[337]
#define VARIATION_REF_consequence_E &at[338]
#define REF_consequence_E_unknown &at[339]
#define REF_consequence_E_splicing &at[340]
#define REF_consequence_E_note &at[341]
#define REF_consequence_E_variation &at[342]
#define REF_consequence_E_frameshift &at[343]
#define consequence_E_frameshift_phase &at[344]
#define E_frameshift_x_length &at[345]
#define E_loss_of_heterozygosity &at[346]
#define of_heterozygosity_reference &at[347]
#define E_loss_of_heterozygosity_test &at[348]
#define VARIATION_REF_location &at[349]
#define VARIATION_REF_ext_locs &at[350]
#define VARIATION_REF_ext_locs_E &at[351]
#define VARIATION_REF_ext &at[355]

#define VARIATION_INST &at[317]
#define VARIATION_INST_type &at[318]
#define VARIATION_INST_delta &at[319]
#define VARIATION_INST_delta_E &at[320]
...
#define frequency_based_validation &at[295]
#define VARIANTPROPERTIES_genotype &at[296]
#define VARIANTPROPERTIES_project_data &at[297]
#define project_data_E &at[298]
#define project_data_E_project_ids &at[299]
#define project_data_E_project_ids_E &at[300]
...
#define DATA_genotype_frequency &at[282]
#define DATA_chromosomes_tested &at[284]
#define POPULATION_DATA_sample_ids &at[285]
#define POPULATION_DATA_sample_ids_E &at[286]

#define EXT_LOC &at[352]
#define EXT_LOC_id &at[353]
#define EXT_LOC_location &at[354]

#define DELTA_ITEM &at[321]
#define DELTA_ITEM_seq &at[322]
#define DELTA_ITEM_seq_literal &at[323]
#define DELTA_ITEM_seq_loc &at[325]
#define DELTA_ITEM_seq_this &at[327]
#define DELTA_ITEM_multiplier &at[328]
#define DELTA_ITEM_multiplier_fuzz &at[329]
#define DELTA_ITEM_action &at[331]
