...
#define PACK_EXTRA_CODE_18(ecode,val) {ecode = ((ecode<<2) & MASK_EXTRA_18) | val;}
#define PACK_EXTRA_CODE_18_2(ecode,val) {ecode = ((ecode<<2) & MASK_EXTRA_18_2) | val;}
#define PACK_EXTRA_CODE_21(ecode,val) {ecode = ((ecode<<2) & MASK_EXTRA_21) | val;}
#define PACK_EXTRA_CODE_MAX(ecode,val) {ecode = ((ecode<<2) & MASK_EXTRA_MAX) | val;}
...
#define MASK1_MAX       0x0000003f
#define MASK2_MAX       0x00000f00
#define MASK3_MAX       0x0003c000
#define MASK4_12_MAX    0x00f00000
#define MASK4_11_MAX    0x00300000
#define MASK5_MAX       0xfc000000
#define MASK1_18_MAX    0x00000003
#define MASK2_12_18_MAX 0x000000f0
#define MASK2_11_18_MAX 0x00000030
#define MASK3_12_18_MAX 0x00000c00
#define MASK3_11_18_MAX 0x00003c00
#define MASK4_12_18_MAX 0x000f0000
#define MASK4_11_18_MAX 0x000c0000
#define MASK5_18_MAX    0x00c00000
#define MASK6_18_MAX    0xfc000000
/* 12 of 16 */
#define GET_WORD_INDEX_12_16_MAX(n) (((n)&MASK1_MAX) | (((n)&MASK2_MAX)>>2) | (((n)&MASK3_MAX)>>4) | (((n)&MASK4_12_MAX)>>6) | (((n)&MASK5_MAX)>>8))
/* 11 of 16 */
#define GET_WORD_INDEX_11_16_MAX(n) (((n)&MASK1_MAX) | (((n)&MASK2_MAX)>>2) | (((n)&MASK3_MAX)>>4) | (((n)&MASK4_11_MAX)>>6) | (((n)&MASK5_MAX)>>10))
/* 12 of 18 */
#define GET_WORD_INDEX_12_18_MAX(n) ((((n)&MASK1_18_MAX)<<4) | (((n)&MASK2_12_18_MAX)<<2) | ((n)&MASK3_12_18_MAX) | (((n)&MASK4_12_18_MAX)>>4) | (((n)&MASK5_18_MAX)>>6) | (((n)&MASK6_18_MAX)>>8))
/* 11 of 18 */
#define GET_WORD_INDEX_11_18_MAX(n) ((((n)&MASK1_18_MAX)<<4) | (((n)&MASK2_11_18_MAX)<<2) | (((n)&MASK3_11_18_MAX)>>2) | (((n)&MASK4_11_18_MAX)>>6) | (((n)&MASK5_18_MAX)>>8) | (((n)&MASK6_18_MAX)>>10))
#define MASK_EXTRA_MAX 0x0000000f
#define GET_EXTRA_CODE_18_MAX(s) (((*(s+1))<<2) | (*(s+2))) & MASK_EXTRA_MAX

#define GET_EXTRA_CODE_PACKED_4_18_MAX(s) ((*(s+1))>>4)
#define GET_EXTRA_CODE_PACKED_18_MAX(s,b,val,ecode) {GET_NEXT_PACKED_NUCL(s,b,ecode); GET_NEXT_PACKED_NUCL(s,b,val); PACK_EXTRA_CODE_MAX(ecode, val);}

#define GET_AMBIG_CONDITION_18_MAX(s) (((*(s+1))&NUC_MASK == 0) && ((*(s+2))&NUC_MASK == 0))
...
#define GET_WORD_INDEX_12_16(n) (((n)&MASK1) | (((n)&MASK2)>>2) | (((n)&MASK3)>>4) | (((n)&MASK4)>>6) | (((n)&MASK5)>>8))
#endif
...
#define GET_EXTRA_CODE_PACKED_21(s,b,val,ecode) {GET_NEXT_PACKED_NUCL(s,b,val); GET_NEXT_PACKED_NUCL(s,b,ecode); GET_NEXT_PACKED_NUCL(s,b,val); PACK_EXTRA_CODE_21(ecode,val); GET_NEXT_PACKED_NUCL(s,b,val); GET_NEXT_PACKED_NUCL(s,b,val); PACK_EXTRA_CODE_21(ecode,val);}
