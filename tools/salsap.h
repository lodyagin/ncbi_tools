...
NLM_EXTERN SeqAlignPtr LIBCALL SeqEntryAlignToMasterFunc (SeqEntryPtr sep, SeqLocPtr master, 
...
/**Offset positions**/
NLM_EXTERN void LIBCALL SeqAlignStartUpdate (SeqAlignPtr salp, SeqIdPtr target_sip, 
...
NLM_EXTERN SeqAnnotPtr LIBCALL aaSeqAnnot_to_dnaSeqAnnot (SeqAnnotPtr sap, ValNodePtr vnp, 
	ValNodePtr framep);
