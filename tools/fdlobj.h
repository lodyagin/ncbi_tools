...
*    Generated using ASNCODE Revision: 6.9 at Sep 17, 2000  9:05 PM
*
**************************************************/
...
*
**************************************************/
typedef struct struct_BlastDefLine BlastDefLineSet;
typedef struct struct_BlastDefLine PNTR BlastDefLineSetPtr;
#define BlastDefLineSetNew() BlastDefLineNew() 
