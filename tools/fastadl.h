...
static AsnType atx[16] = {
  ...
  {402, "Blast-def-line" ,1,0,0,0,0,1,0,0,NULL,&atx[15],&atx[3],0,&atx[7]} ,
  {0, "title" ,128,0,0,0,0,0,0,0,NULL,&atx[4],NULL,0,&atx[5]} ,
